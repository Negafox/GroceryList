...
QMAKE    = /usr/bin/qmake
GroceryList.xcodeproj/project.pbxproj: GroceryList.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o GroceryList.xcodeproj/project.pbxproj GroceryList.pro
